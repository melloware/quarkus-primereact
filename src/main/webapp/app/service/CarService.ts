...
export const usePostEntityCars = <TError = ErrorType<unknown>,
    ...
    TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<ReturnType<typeof usePostEntityCarsHook>>>, TError, { data: Car }, TContext>, }
    ) => {
...
export const useGetEntityCarsManufacturersHook = () => {
    ...
    return (
        ...
        return getEntityCarsManufacturers(
            {
                url: `/entity/cars/manufacturers`, method: 'get', signal
            },
        );
    }
}
...
export const useGetEntityCarsManufacturers = <TData = Awaited<ReturnType<ReturnType<typeof useGetEntityCarsManufacturersHook>>>, TError = ErrorType<unknown>>(
    options?: { query?: UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useGetEntityCarsManufacturersHook>>>, TError, TData>, }
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<ReturnType<typeof useGetEntityCarsManufacturersHook>>>> = ({ signal }) => getEntityCarsManufacturers(signal);

    const query = useQuery<Awaited<ReturnType<ReturnType<typeof useGetEntityCarsManufacturersHook>>>, TError, TData>(queryKey, queryFn, queryOptions) as UseQueryResult<TData, TError> & { queryKey: QueryKey };
...
export const usePutEntityCarsId = <TError = ErrorType<unknown>,
    ...
    TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<ReturnType<typeof usePutEntityCarsIdHook>>>, TError, { id: number; data: Car }, TContext>, }
    ) => {
    const { mutation: mutationOptions } = options ?? {};
