...
export const getGetEntityCarsQueryKey = (params?: GetEntityCarsParams) => [`/entity/cars`, ...(params ? [params] : [])] as const;
...
): UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useGetEntityCarsHook>>>, TError, TData> & { queryKey: QueryKey } => {
...
export const getGetEntityCarsManufacturersQueryKey = () => [`/entity/cars/manufacturers`] as const;
...
}): UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useGetEntityCarsManufacturersHook>>>, TError, TData> & { queryKey: QueryKey } => {
	const { query: queryOptions } = options ?? {};
...
export const getGetEntityCarsIdQueryKey = (id: number) => [`/entity/cars/${id}`] as const;
...
): UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useGetEntityCarsIdHook>>>, TError, TData> & { queryKey: QueryKey } => {
	const { query: queryOptions } = options ?? {};
