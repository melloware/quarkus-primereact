...
export const useLoggingManagerUpdateMutationOptions = <TError = ErrorType<void | void>, TContext = unknown>(options?: {
...
export type LoggingManagerUpdateMutationError = ErrorType<void | void>;

/**
 * @summary Update log level
 */
export const useLoggingManagerUpdate = <TError = ErrorType<void | void>, TContext = unknown>(
	options?: {
		mutation?: UseMutationOptions<
			Awaited<ReturnType<ReturnType<typeof useLoggingManagerUpdateHook>>>,
			TError,
